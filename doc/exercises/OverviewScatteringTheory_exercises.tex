% %
% \LaTeX\ file with exercises for the TALENT/INT course in July, 2013.
%
%###########################################################################%
%###########################################################################%


% Now for the preamble, where the document declarations (like 12pt and
%  what style to use) are given.

% Options for documentstyle:
%  Currently using ntgaip, but this needs a lot of tuning.
